...
from geometry_msgs.msg import PoseStamped, Point # Message Types Used (Target Pose)
...
class HarpoonLaserNode(Node):
        def __init__(self): # Defines HarpoonFiringNode which inherits from rclpy.node.Node.
            ...
            # Subscribe to Fox poses from LIDAR: Subscribes to /detected_object_pose of type PoseStamped.
